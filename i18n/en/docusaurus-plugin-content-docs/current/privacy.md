...
Readium (“the app”) respects your privacy. This page explains how data may be handled while using the app.

> Summary  
> - Your reading logs/sessions/notes/timeline are stored **locally on your device**.  
...
Readium does not upload your reading logs, sessions, notes, or timeline content to a Readium server.
...
The following data is stored in the app’s local database:
